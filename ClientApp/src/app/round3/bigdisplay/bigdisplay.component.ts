...
import { round1QDisplay, roundCategory, roundThreeCategoryPoints } from 'src/app/data/data';
import { environment } from 'src/environments/environment';
import { Store } from '@ngrx/store';
import { selectCurrentEvent, selectRound3BigDisplay, selectRound3Categories, selectRound3CategoryPoints } from 'src/app/store';
import { round3BigDisplay, round3Categories, round3CategoryPoints } from 'src/app/store/round3/round3.actions';
...
export class Round3BigdisplayComponent implements OnInit, OnDestroy{
  ...
  // external URIs
  finalJepSound = new Audio('../../../assets/storage/final_audio.mp3');
