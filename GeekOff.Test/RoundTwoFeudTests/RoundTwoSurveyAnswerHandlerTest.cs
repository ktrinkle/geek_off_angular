...
public class RoundTwoSurveyAnswerHandlerTest
{
    ...
    public RoundTwoSurveyAnswerHandlerTest()
    {
        _contextGo = Substitute.For<ContextGo>();
        
        _serviceProvider = _services
            .AddMediatR(cfg => cfg.RegisterServicesFromAssemblies(typeof(RoundTwoSurveyAnswerHandler).Assembly))
    ...
    [Fact]
    public async Task Handle_RoundTwoSurveyAnswerHandler_Questions()
    {
        // Arrange
        _ = _serviceProvider.GetRequiredService<IMediator>();

        var handler = new RoundTwoSurveyAnswerHandler.Handler(_contextGo);
        var request = new RoundTwoSurveyAnswerHandler.Request(){
            YEvent = "t24"
        };
    ...
    [Fact]
    public async Task Handle_RoundTwoSurveyAnswerHandler_NotFound()
    {
        // Arrange
        _ = _serviceProvider.GetRequiredService<IMediator>();
